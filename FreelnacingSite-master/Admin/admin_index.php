					...
					if(isset($_GET['approve']))
					{
						...
						if(isset($_GET['email']))
						{
							...
							if($result_email = mysqli_query($connection, $query))
							{
								...
								$mail->setFrom('priyagupta12530@gmail.com', $firstname);
								$mail->addAddress($email);     

								$mail->isHTML(true);
								$mail->Subject = "Alorb-Regestration Approved";
								$mail->Body = '<p>Hey '.$firstname. ', your Regestration is Approved By our Team. Kindly Login here, 
								
								<a href="http://localhost/Project-Alorb/">http://localhost/Project-Alorb/</a>
			...
			<footer class="py-4 bg-light mt-auto">
				<div class="container-fluid">
					<div class="d-flex align-items-center justify-content-between small">
						<div class="text-muted">&copy; Alorb 2024 </div>
						<div>
