...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href="view_profile.php"><img src="images/logo.jpg" alt="logo" style="border-radius: 5px; margin-bottom: -12px;"> Update Profile <br> <span style="font-size: 15px; margin-left: 40px;">( Alorb )</span> </a>
