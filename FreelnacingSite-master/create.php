...
<body class="create-your-profile-body">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
			<a class="navbar-brand" style="color: teal; font-weight: bold;" href="my-hires.php"><img src="images/logo.jpg" alt="logo" style="border-radius: 5px; margin-bottom: -15px;"> Profile Build Up <br> <span style="font-size: 15px; margin-left: 30px;">( Alorb )</span></a>
						...
						<div id="languages-column">
							<div class='input-group'>
								<select class='form-control' name="other_lang" required>
									...
									<option value='punjabi'>Bhojpuri</option>
...
?>
			...
			<div class="tab-pane fade col-md-6" id="Hourly-Rate" role="tabpanel" aria-labelledby="hourly-rate-tab">
				<div class="card" style="text-align: left;">
					...
					<p><b>Alorb Service fee</b><br>
						Alorb will charge 20% when you begin a contract with a new client</p>
					<div style="text-align: right; padding-top: 3%;">
